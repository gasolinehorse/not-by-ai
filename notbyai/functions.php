...
wp_enqueue_style( 'bs-css', get_template_directory_uri() . '/bootstrap.min.css' );
wp_enqueue_style( 'blankslate-style', get_stylesheet_uri(), array(), rand(111,9999), 'all' );
wp_enqueue_script( 'jquery' );
wp_enqueue_script( 'bs-js', get_template_directory_uri() . '/bootstrap.bundle.min.js' );
}
