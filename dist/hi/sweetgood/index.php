      ...
      <header class="row no-md-bg justify-content-center text-start pt-1 pb-3 mb-3 mb-md-5 bg-light" style="margin-top: -1.8rem; background-image: url(/img/creator-profile-of-not-by-ai.svg); background-position: bottom right; background-repeat: no-repeat;">
        <div class="col-md-11 col-xl-8 pt-1">
          <div class="row position-relative z-1">
            <div class="col">
              <small class="xs"><a href="https://notbyai.fyi" class="text-decoration-underline">Home</a> <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> Creations <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> SWEETGOOD</small>
            </div>
          </div>
          <div class="row justify-content-start pt-3 pb-2">
            <div class="col-auto">
              <img width="95" class="border rounded img-fluid position-relative z-1" src="/hi/sweetgood/img/logo.png" alt="logo">
            </div>
            <div class="col-auto">
              <h1 class="h5 mt-1 mb-0 ls-normal" style="letter-spacing: 0;">Not By AI - Creator Profile</h1>
              <h2 class="display-2 my-0 lh-sm" style="background-color: #f9f8f7; box-shadow: #f9f8f7 10px 0px 40px 40px;">SWEETGOOD <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path fill="#007CE4" fill-rule="evenodd" d="m9.545 18.48-1.45.885a1.781 1.781 0 0 1-2.616-.952l-.543-1.61a.871.871 0 0 0-.695-.584l-1.68-.254a1.782 1.782 0 0 1-1.392-2.412l.62-1.582a.871.871 0 0 0-.158-.894L.507 9.803A1.782 1.782 0 0 1 .991 7.06l1.492-.814a.872.872 0 0 0 .454-.786l-.042-1.699a1.782 1.782 0 0 1 2.133-1.79l1.666.336c.32.065.65-.055.853-.31L8.607.67a1.782 1.782 0 0 1 2.784 0l1.06 1.328a.872.872 0 0 0 .854.31l1.665-.335a1.781 1.781 0 0 1 2.133 1.79l-.041 1.698a.872.872 0 0 0 .454.786l1.492.814a1.782 1.782 0 0 1 .483 2.742l-1.123 1.274a.871.871 0 0 0-.158.894l.62 1.582a1.782 1.782 0 0 1-1.392 2.412l-1.68.254a.871.871 0 0 0-.696.583l-.542 1.61a1.782 1.782 0 0 1-2.616.953l-1.45-.885a.872.872 0 0 0-.909 0Z" clip-rule="evenodd"/><path fill="#fff" fill-rule="evenodd" d="m15.083 8.685-5.982 5.983-4.185-4.185 1.506-1.506 2.679 2.678 4.476-4.476 1.506 1.506Z" clip-rule="evenodd"/></svg></h2>
              <small class="xs">By Christian Süßenguth</small>
            </div>
          </div>
        </div>
      </header>
      <div class="row justify-content-center">
        <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-2 order-md-3">
          ...
          <section>
            ...
            <p class="mb-2">🇩🇪 Alle Inhalte wurden zu 100% von Menschen und ohne jeglichen Einsatz von künstlicher Intelligenz erstellt. Das gilt auch für alle Grafiken auf der Seite. </p>
            <p>🇺🇸 All content was 100% created by humans and without any use of artificial intelligence. This also applies to any graphics on the page.</p>
          </section>
            ...
            <div class="row pb-3 px-2 mb-3">
              <div class="col">
                ...
                <div class="pb-1 pb-lg-3 pt-2">
                  ...
                  <div class="creator-profile__field">
                    <a class="text-decoration-underline" href="https://sweetgood.de" target="_blank">sweetgood.de</a>
                  </div>
                </div>
                <div class="pb-3 pt-3">
