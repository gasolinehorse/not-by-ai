            ...
            <div class="row pb-3 px-2 mb-3">
              <div class="col">
                ...
                <div class="pb-1 pb-md-3 pt-2">
                  ...
                  <div class="creator-profile__field">
                    <?php 
                    function truncateString($string, $maxLength = 100, $ellipsis = '...')
                    {
                      if (strlen($string) <= $maxLength) {
                        return $string;
                      }
                      $truncatedURL = substr($string, 0, $maxLength - strlen($ellipsis)) . $ellipsis;
                      return $truncatedURL;
                    }
                    $truncatedURL = truncateString($project_url, 28);
                    ?>
                    <a class="text-decoration-underline text-nowrap" href="https://<?php echo $project_url; ?>" target="_blank"><?php echo $truncatedURL; ?></a>
                  </div>
                </div>
                <div class="pb-3 pt-3">
