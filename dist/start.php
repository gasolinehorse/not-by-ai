        ...
        <div class="row justify-content-center">
            ...
            if (isset($_GET['error'])) {
              if ($_GET['error'] == 'invalid_email') {
                echo '<p class="py-2 rounded-2 small" style="background-color: rgb(255, 232, 232);">Invalid user. Please try again or <a href="mailto:help@notbyai.fyi?subject=Creator Page Login Issues" class="text-decoration-underline" tartget="_blank">contact us</a> if you have any questions.</p>';
              }
            }
            ?>
