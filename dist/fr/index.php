      ...
      <section class="col-12 mx-auto px-5 px-sm-4 px-xl-0 pt-3" style="max-width: 1052px;">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-7 p-2 bg-white rounded-5 mt-3">
            ...
            <p class="small my-1">Vous êtes en bonne compagnie. Les badges Not By AI / Pas par l’IA figurent sur <?php include '../all-stats.php'; ?> pages.</p>
          </div>
        </div>
      </section>
    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>D’après une spécialiste de l’IA, 90 % des contenus en ligne pourraient être générés par l’IA en 2025.<sup>1</sup> Avec l’explosion des contenus générés par IA, il est important de rappeler que l’IA est entraînée sur des contenus générés par des hommes et des femmes. Si les humains deviennent dépendants à l’IA pour générer des contenus, ces nouveaux contenus générés par IA se contenteront de recycler des contenus du passé. Cela constituerait un obstacle majeur au progrès humain.<sup>2</sup> Pour que notre espèce continue d’avancer, nous devons limiter la dépendance à l’IA et continuer de créer des œuvres originales.</p>
          <figure>
