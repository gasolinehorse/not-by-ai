      ...
      <div class="container pt-3">
        <div class="row mt-3">
          <div class="col-lg-4 text-center text-md-start pb-5 pb-lg-3">
            ...
            <div class="display-2 lh-sm pb-2">Rejoignez le mouvement Not By AI / Pas par&nbsp;l’IA</div>
            <p style="font-size: 1.3125rem;">Avec un badge, nous donnons aux humains la capacité de créer des contenus authentiques.</p>
          ...
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">Ressources</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help">Centre d’aide</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/what-is-the-not-by-ai-90-rule">La règle des 90 %</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help#how-to">Insérer un badge</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/guidelines">Consignes d’utilisation</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/translate">Aidez-nous à traduire</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">Société</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/about">Qui nous sommes</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/feedback">Votre avis</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/media-assets">Assets média</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/newsroom">Dans la presse</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/meet-our-translators">Nos traducteurs</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/contact">Nous contacter</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <a href="https://notbyai.fyi/hi/not-by-ai"><img class="pt-3 d-block mx-auto" src="/img/written-by-human-not-by-ai-white-fr.svg" alt="Written By Human, Not By AI"></a>
            <p class="small text-center pt-5"><br><a href="https://notbyai.fyi/app/signup/" class="for-business-link rounded-2 mb-2">Créer un compte</a><br><a href="https://notbyai.fyi/app/login/">Se connecter</a></p>
          </div>
        </div>
        <div class="row flex-column flex-md-row align-content-between pt-4 pb-5">
          ...
          <div class="col justify-content-center justify-content-md-end text-center text-md-end">
            <a href="https://notbyai.fyi/license" class="display-6 me-4 opacity-50">Licence</a>
            <a href="https://notbyai.fyi/privacy-policy" class="display-6 me-4 opacity-50">Politique de confidentialité</a>
            <a href="https://notbyai.fyi/terms-and-conditions" class="display-6 me-4 opacity-50">Terms&nbsp;&&nbsp;Conditions</a>
            <a href="#" class="termly-display-preferences display-6 opacity-50">Préférences de consentement</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content border-0 rounded-0 download-popup">
        <div class="modal-header px-md-5 py-md-4 align-items-start">
          <div class="modal-title fs-3 h3" id="downloadEmailLabel">Téléchargez les badges <span class="d-none d-sm-inline-block">Not&nbsp;By&nbsp;AI&nbsp; / Pas par l’IA</span></div>
        ...
        <div class="modal-body pb-4 pt-md-4 pb-5 px-lg-5">
          <form id="forms" method="post" action="../process-form.php">
                  ...
                  <div class="not-by-ai-options border rounded-3 my-2 pt-3 px-2 px-md-3 bg-white shadow h-100">
                    ...
                    <label class="form-check-label pt-1 pt-sm-3 w-100 cursor-pointer h-100" for="usage2">
                      <div class="row justify-content-center align-items-center mb-3 px-5 px-sm-3 d-none d-sm-flex">
                        ...
                        <div class="col-5">
                          <img id="not-by-ai-offering-badges" class="img-fluid shadow" srcset="/img/sign-up-not-by-ai-pages@2x.png 2x" src="/img/sign-up-not-by-ai-pages.png" alt="Not By AI project">
                        </div>
                      </div>
                      <h4 class="h5 mb-0">Télécharger les badges et expliquer mon approche centrée sur l’humain à mon public</h4>
                      <div class="mt-2" style="font-size: 0.75rem;"><span class="opacity-50">À partir de 5 $/m</span><span class="d-block d-md-inline-block border rounded-2 ms-lg-2 mt-1 mt-lg-0 py-1 px-2"><span class="opacity-50">Utilisation commerciale & personnelle</span></span></div>
                    </div>
                  </label>
                </div>
                <div class="col-6">
                  <div class="not-by-ai-options border rounded-3 my-2 pt-3 px-2 px-md-3 bg-white shadow h-100">
                    ...
                    <label class="form-check-label pt-1 pt-sm-3 w-100 cursor-pointer h-100" for="usage1">
                      ...
                      <h4 class="h5 mb-0">Télécharger les badges et c’est tout</h4>
                      <div class="mt-2" style="font-size: 0.75rem;"><span class="opacity-50">Prix libre</span><span class="d-block d-md-inline-block border rounded-2 ms-lg-2 mt-1 mt-lg-0 py-1 px-2"><span class="opacity-50">Utilisation personnelle uniquement</span></span></div>
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div id="personal-form" class="mt-md-3 px-1 px-sm-3 px-lg-1">
              ...
              <div class="pt-3">
                <div class="d-flex">
                  <input type="checkbox" id="marketing" name="marketing" value="I want to receive news such as updates, tips, resources, and discounts."><label for="marketing">Je veux recevoir des actus, nouveautés, conseils, ressources et réductions.</label>
                </div>
              </div>
              <label for="nogo" class="d-none">Company</label>
              <input type="text" name="nogo" class="d-none">
              <input id="not-by-ai-badges-download-no-cost" class="g-recaptcha btn mt-4" data-sitekey="6LcD-NsnAAAAAJ1SLXijs4KO4J2IX2OJHbABIumM" data-callback="onSubmit" data-action="submit" type="submit" value="Envoyez-moi le badge">
              <a id="not-by-ai-badges-download-with-donation-no-cp" style="display: none;" href="https://donate.stripe.com/dR67uh7oe2hucOAcMR" class="btn mt-4">Envoyez-moi le badge</a>
              <div class="xs opacity-50 mt-2">En cliquant sur le bouton ci-dessus, vous acceptez nos <a href="https://notbyai.fyi/terms-and-conditions" class="text-decoration-underline">Conditions d’utilisation.</a>.</div>
            </div>
            <div id="join-not-by-ai" class="text-center d-none">
              <a class="btn mt-3" href="https://notbyai.fyi/app/signup/">Commencez</a>
              <div class="small opacity-50 mt-3">ou <a href="https://buy.stripe.com/4gw01P6ka09mbKw9AB" class="text-decoration-underline">Téléchargez uniquement les badges pour des frais uniques de 99 $</a></div>
            </div>
          </form>
        </div>
      </div>
