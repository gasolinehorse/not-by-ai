<?php
$pageTitle = 'Not By AI Help Center | How do you ensure Not By AI badge usage complies with the Not By AI 90% Rule?';
    ...
    <main>
      <header class="row no-md-bg justify-content-center text-start pt-1 pb-2 mb-3 mb-md-5 bg-light" style="background-image: url(/img/creator-profile-of-not-by-ai.svg); background-position: top right; background-repeat: no-repeat; background-attachment: fixed;">
        <div class="col-md-11 col-xl-8 pt-1">
          <div class="row">
            <div class="col">
              <small class="xs bg-for-title"><a href="https://notbyai.fyi" class="text-decoration-underline">Home</a> <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> <a href="https://notbyai.fyi/help" class="text-decoration-underline">Help Center</a> <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> How do you ensure Not By AI badge usage complies with the Not By AI 90% Rule?</small>
            </div>
          </div>
        </div>
      </header>
      <div class="row justify-content-center">
        <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-2 pb-4 order-md-3">
          <section>
            ...
            <p>For our paid users, we manually review project details and relevant content, reaching out to collaborate with content creators for further validation when necessary. Whenever possible, we may also leverage third-party tools to detect potential AI-generated content. However, we rely on our content creators to be the ones to adhere to the <a href="/help/what-is-the-not-by-ai-90-rule.php" class="text-decoration-underline">Not By AI 90% Rule</a>. While we continually seek talents to assist with future content verification, it is important to note that it is our creators who take the lead in such verification. As for our free users, we rely on their commitment in the same way we do with our paid users.</p> 
