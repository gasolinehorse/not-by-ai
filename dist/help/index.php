    ...
    <main class="row justify-content-center px-4 px-lg-0">
      ...
      <section class="col-lg-11 col-xl-10 py-5 text-start">
        ...
        <div class="bg-light p-3">
          <p class="mb-0">Pro tip: Don't know which image format to use? <a class="text-decoration-underline" href="/help/which-image-file-format-should-i-use.php">Check out our guide</a>. And remember, you should always <a class="text-decoration-underline" href="/help/how-do-i-link-my-not-by-ai-badge.php">link your badge</a> when it is possible.</p>
        </div>
      </section>
