      ...
      <div class="row justify-content-center">
        <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-2 pb-4 order-md-3">
          <section>
            ...
            <p>The linking method varies depending on how you choose to display the Not By AI badge. If your content is hosted on writing platforms such as WordPress, Medium, Squarespace, and LinkedIn, or if your content is in a text editor like Google Docs or Word, follow the general steps below:</p> 
            <ol>
            ...
            <p>Be sure to replace the image path in src="..." with your image location, replace the URL in href="..." with your Creator Page link if you are a paid user, and replace the Writer badge with the badge you intend to use.</p>
          </section>
          <section class="py-4">
