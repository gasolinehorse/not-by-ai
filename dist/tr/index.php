    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>Bir uzman, 2025 yılında dijital içeriklerin  %90 kadarının YZ tarafından üretileceğini tahmin ediyor.<sup>1</sup>  Yapay zeka tarafından üretilen içeriklerdeki bu yükseliş ile birlikte, yapay zekanın insan tarafından üretilen içeriklerle eğitildiğini hatırlamak gerekmektedir. İnsanlar içerik üretmek için yalnızca yapay zekaya güvenirse, yapay zeka tarafından üretilen yeni içerikler yalnızca geçmişten gelen geri dönüştürülmüş içerikler olabilir. Bu durum, insanlığın ilerlemesine büyük bir engel teşkil edebilir.2 Ancak yapay zekaya olan bağlılığımızı sınırlayarak ve özgün içerikler üretmeye devam ederek türümüzün ilerlemesini sağlayabiliriz.</p>
          <figure>
