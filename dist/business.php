<?php
$pageTitle = 'Not By AI for business — Add the Not By AI Badge to Human-Created Content';
            ...
            <div class="accordion" id="accordionExample" data-bs-theme="dark" style="filter: grayscale(100%);">
              ...
              <div class="accordion-item">
                ...
                <div id="collapseChoose" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    If you are not sure which badge to use, the Produced By Humans, Not By AI badge is likely the most suitable option. You can also use the contact form to suggest a new badge or request an answer from us. We are happy to help!
                  </div>
                </div>
              </div>
            </div>
