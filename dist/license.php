      ...
      <div class="col-md-10 col-xl-9 py-4">
        <div class="row justify-content-center text-start">
          <div class="col-lg-7">
            ...
            <p>"Badge" means any badge, logo, or other mark provided by Not By AI that may be used to indicate that content is primarily or entirely created by one or more humans.</p>
            ...
            <p>Not By AI grants to Licensee a non-exclusive, non-transferable, and limited license to use the Badge in connection with Licensee's Content, subject to the terms and conditions of this Agreement. Use of the Badge for commercial purposes or to access additional services, such as hosting project pages, requires a Not By AI membership subscription.</p>
            ...
            <ul>
              ...
              <li>Use the Badge for any unlawful purpose or in any way that interrupts, damages, impairs, or renders Not By AI less efficient.</li>
              <li>Provide false, inaccurate, or misleading information regarding their project details, creative process, or the extent of AI involvement in the creation of their Content. Licensees must ensure that all information provided to Not By AI, especially for the purpose of using project pages or for the verification process under the Not By AI 90% Rule, is truthful, accurate, and complete. Failure to provide accurate information may result in termination of the License to use the Badge and any associated services, including project pages.</li>
            </ul>
            
            <p class="fw-bold pt-2 mb-2">7. Indemnification</p>
            
            <p>Licensee agrees to indemnify and hold Not By AI harmless from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising out of or in connection with Licensee's use of the Badge and membership.</p>
            
            <p class="fw-bold pt-2 mb-2">8. Term and Termination</p>
            
            <p>This Agreement will commence on the date Licensee downloads the Badge or becomes a Not By AI memeber, and will continue in effect until terminated by either party. Either party may terminate this Agreement at any time for any reason by giving at least thirty (30) days prior written notice to the other party. Not By AI may also terminate this Agreement immediately if Licensee breaches any provision of this Agreement or fails to comply with the Not By AI 90% Rule. Upon termination, Licensee will immediately cease using the Badge and any Not By AI properties and destroy all copies of the Badge in its possession or control.</p>

            <p>Not By AI reserves the right to terminate the Licensee's membership and subscription if the monthly or yearly fee is not paid on time or if the Licensee breaches any terms of this Agreement.</p>
