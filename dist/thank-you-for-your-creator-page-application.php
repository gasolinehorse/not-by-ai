<?php
$pageTitle = 'Thank You for Your Not by AI Creator Page Application';
$pageDes = 'We have received your Creator Page application. You will be contacted after the review. Thank you for your application and we cannot wait to see it.';
include 'header.php';
include 'top-nav.php';
?>
