  <div class="container-fluid bg-white text-center curve">
    <div class="row border-bottom align-items-center mb-4 mb-xl-5">
      ...
      <div class="col-sm-4 col-lg-5 text-end pe-4 d-none d-md-block">
        <ul class="list-unstyled d-inline">
          <li class="d-inline"><a class="xs px-3" href="https://notbyai.fyi/app/login">Log In</a></li>
          <li class="d-inline"><a class="xs px-3 me-4 me-sm-3 me-lg-5" href="https://notbyai.fyi/app/signup">Join Us <img src="/img/download-not-by-ai-badge.svg" alt="" style="transform: rotate(-90deg); margin-bottom: 3px;"></a></li>
        </ul>
      </div>
    </div>