    ...
    <div class="row justify-content-center px-4 px-lg-0">
  	...
  	<div class="row justify-content-center  pb-5">
    	...
    	<div class="col-sm-8 col-md-7 col-lg-3">
      	...
      	<p class="mb-0">From a human to a human, please consider a small donation to make a big impact. <span class="fw-bold d-block pt-2">Support us.<br> Support originality.<br> Support humans.</span></p>
      	<script async
