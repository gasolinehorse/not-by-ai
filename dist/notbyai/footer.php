      ...
      <div class="col text-center py-3 text-center">
        <a href="<? bloginfo('url') ?>/translate" class="display-6 pt-3 text-decoration-underline me-2 me-sm-3">Help Us Translate</a>
        <a href="<? bloginfo('url') ?>/feedback" class="display-6 pt-3 text-decoration-underline me-2 me-sm-3">Feedback</a>
        <a href="<? bloginfo('url') ?>/about" class="display-6 pt-3 text-decoration-underline me-2 me-sm-3">About Us</a>
