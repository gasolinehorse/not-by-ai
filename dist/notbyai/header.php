...
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon-not-by-ai_32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon-not-by-ai_16x16.png">
<link rel="apple-touch-icon" type="image/png" sizes="180x180" href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicon-not-by-ai.png">
...
<meta name="twitter:image" content="<?php echo get_stylesheet_directory_uri(); ?>/img/not-by-ai-share.png" />
