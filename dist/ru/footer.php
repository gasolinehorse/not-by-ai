      ...
      <div class="container pt-3">
        <div class="row mt-3">
          <div class="col-lg-4 text-center text-md-start pb-5 pb-lg-3">
            ...
            <div class="display-2 lh-sm pb-2">Присоединяйтесь к движению Not&nbsp;By&nbsp;AI&nbsp;</div>
            <p style="font-size: 1.3125rem;">С помощью значка мы даем людям возможность создавать аутентичный контент.</p>
          ...
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">Значки</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/how-it-works">Как это работает</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/pricing">Цены</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/ru">Not By AI для личного использования</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/business">Not By AI для бизнеса</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/gallery">Галерея</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">Ресурсы</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help">Справочный центр</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/what-is-the-not-by-ai-90-rule">Правило 90% Не ИИ</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help#how-to">Как вставить значки</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/guidelines">Рекомендации по использованию</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/translate">Помогите нам перевести</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">Компания</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/about">О нас</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/feedback">Обратная связь</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/media-assets">Медиа-активы</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/newsroom">Новости</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/meet-our-translators">Наши переводчики</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/contact">Связаться с нами</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <a href="https://notbyai.fyi/hi/not-by-ai"><img class="pt-3 d-block mx-auto" src="/img/ru/written-by-human-not-by-ai-white.svg" alt="Written By Human, Not By AI"></a>
            <p class="small text-center pt-5"><br><a href="https://notbyai.fyi/app/signup/" class="for-business-link rounded-2 mb-3 me-3">Присоединиться</a><a href="https://notbyai.fyi/app/login/">Войти</a></p>
          </div>
        </div>
        <div class="row flex-column flex-md-row align-content-between pt-4 pb-5">
          <div class="col-md-3 col-lg-4">
            <div class="display-6 mt-1 text-center text-md-start opacity-50 pb-2">Not By AI © <?php echo date('Y'); ?> Все права защищены.</div>
          </div>
          <div class="col justify-content-center justify-content-md-end text-center text-md-end">
            <a href="https://notbyai.fyi/license" class="display-6 me-4 opacity-50">лицензия</a>
            <a href="https://notbyai.fyi/privacy-policy" class="display-6 me-4 opacity-50">политика конфиденциальности</a>
            <a href="https://notbyai.fyi/terms-and-conditions" class="display-6 me-4 opacity-50">условия и положения</a>
            <a href="#" class="termly-display-preferences display-6 opacity-50">Настройки согласия</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content border-0 rounded-0 download-popup">
        <div class="modal-header px-md-5 py-md-4 align-items-start">
          <div class="modal-title fs-3 h3" id="downloadEmailLabel">Скачать значки Not By AI</div>
        ...
        <div class="modal-body pb-4 pt-md-4 pb-5 px-lg-5">
          <form id="forms" method="post" action="../process-form.php">
            <noscript>Для заполнения этой формы включите JavaScript в вашем браузере.</noscript>
            <p class="small my-0 w-100 text-center">Я хочу</p>
                  ...
                  <div class="not-by-ai-options border rounded-3 my-2 pt-3 px-2 px-md-3 bg-white shadow h-100">
                    ...
                    <label class="form-check-label pt-1 pt-sm-3 w-100 cursor-pointer h-100" for="usage2">
                      <div class="row justify-content-center align-items-center mb-3 px-5 px-sm-3 d-none d-sm-flex">
                        ...
                        <div class="col-5">
                          <img id="not-by-ai-offering-badges" class="img-fluid shadow" srcset="/img/sign-up-not-by-ai-pages@2x.png 2x" src="/img/sign-up-not-by-ai-pages.png" alt="страница проекта Not By AI">
                        </div>
                      </div>
                      <h4 class="h5 mb-0">Загрузить значки и описать мой человеко-ориентированный подход к моим пользователям</h4>
                      <div class="mt-2" style="font-size: 0.75rem;"><span class="opacity-50">От $5/мес.</span><span class="d-block d-md-inline-block border rounded-2 ms-lg-2 mt-1 mt-lg-0 py-1 px-2"><span class="opacity-50">Коммерческое и личное использование</span></span></div>
                    </div>
                  </label>
                </div>
                <div class="col-6">
            ...
            <div id="personal-form" class="mt-md-3 px-1 px-sm-3 px-lg-1">
              <div class="row justify-content-between">
                ...
                <div id="donate-box" class="col-6 col-md-5 col-lg-4 border-md pb-1 pb-md-3 pt-2 px-md-4 rounded-3 mt-md-0">
                  <label for="your-price">Оплата по вашему желанию</label>
              ...
              <div class="pt-3">
                <div class="d-flex">
                  <input type="checkbox" id="marketing" name="marketing" value="I want to receive news such as updates, tips, resources, and discounts."><label for="marketing">Я хочу получать новости, такие как обновления, советы, ресурсы и скидки.</label>
                </div>
              </div>
              <label for="nogo" class="d-none">Company</label>
              <input type="text" name="nogo" class="d-none">
              <input id="not-by-ai-badges-download-no-cost" class="g-recaptcha btn mt-4" data-sitekey="6LcD-NsnAAAAAJ1SLXijs4KO4J2IX2OJHbABIumM" data-callback="onSubmit" data-action="submit" type="submit" value="Отправьте мне значок">
              <a id="not-by-ai-badges-download-with-donation-no-cp" style="display: none;" href="https://donate.stripe.com/dR67uh7oe2hucOAcMR" class="btn mt-4">Отправьте мне значок</a>
              <div class="xs opacity-50 mt-2">Нажимая кнопку выше, вы соглашаетесь с нашими <a href="https://notbyai.fyi/terms-and-conditions" class="text-decoration-underline">Условиями</a>.</div>
            </div>
            <div id="join-not-by-ai" class="text-center d-none">
              <a class="btn mt-3" href="https://notbyai.fyi/app/signup/">Присоединяйтесь к Not By AI</a>
              <div class="small opacity-50 mt-3">Или <a href="https://buy.stripe.com/4gw01P6ka09mbKw9AB" class="text-decoration-underline">заплатите один раз 99 долларов, чтобы скачать значки.</a></div>
            </div>
          </form>
        </div>
      </div>
