    ...
    <main>
      ...
      <section class="mx-auto px-5 px-sm-4 px-xl-0 pt-3" style="max-width: 1052px;">
        ...
        <div class="row justify-content-center">
        	<div class="col-lg-8 gx-4 h5 p-3 bg-light rounded-5 mt-2">Вы в хорошей компании. Значки Not By AI представлены на более чем <?php include '../all-stats.php'; ?>тыс. страниц.
          </div>
        </div>
      </section>
    </main>
    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>Все движение Not By AI создано реальными людьми. Ваша поддержка будет иметь значение. Пожертвуйте сегодня, чтобы дать возможность создателям контента и обеспечить дальнейшее развитие человечества. Ваше <a class="text-decoration-underline" href="https://donate.stripe.com/dR66qd4c22hucOAdQS" target="_blank">пожертвование</a> будет использовано для <a href="/help/where-does-donation-money-go.php" class="text-decoration-underline">развития</a> Not By AI. Спасибо.</p>
