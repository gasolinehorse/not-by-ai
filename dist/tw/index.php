      ...
      <section class="col-12 mx-auto px-5 px-sm-4 px-xl-0 pt-3" style="max-width: 1052px;">
                ...
                <div class="col-12 not-by-ai-folder-wrapper rounded px-2 px-xl-3 pt-3 pb-2">
                  <div class="not-by-ai-folder fade-in-move-up position-relative pb-1">
                    ...
                    <div class="position-absolute bottom-0 z-3 w-100 pb-2 pb-mb-3 pb-lg-4 d-flex flex-column flex-lg-row align-items-center justify-content-evenly not-by-ai-badge-folder">
                      <img id="example-not-by-ai-badge-artist-wht" width="131" height="42" class="no-download img-fluid pb-3 pb-sm-4 pb-md-3 pb-lg-0" src="/img/painted-by-human-not-by-ai-white-tw.svg" alt="">
                      <img id="example-not-by-ai-badge-artist-blk" width="131" height="42" class="no-download img-fluid d-block d-sm-none d-md-inline-block pb-3 pb-md-2 pb-lg-0" src="/img/painted-by-human-not-by-ai-black-tw.svg" alt="">
                    </div>
                  </div>
                </div>
              ...
              <span class="row">
                <div class="col-12 not-by-ai-folder-wrapper rounded px-2 px-xl-3 pt-3 pb-2">
                  <div class="not-by-ai-folder fade-in-move-up position-relative pb-1">
                    ...
                    <div class="position-absolute bottom-0 z-3 w-100 pb-2 pb-mb-3 pb-lg-4 d-flex flex-column flex-lg-row align-items-center justify-content-evenly not-by-ai-badge-folder">
                      <img id="example-not-by-ai-badge-writer-wht" width="131" height="42" class="no-download img-fluid pb-3 pb-sm-4 pb-md-3 pb-lg-0" src="/img/written-by-human-not-by-ai-white-tw.svg" alt="">
                      <img id="example-not-by-ai-badge-writer-blk" width="131" height="42" class="no-download img-fluid d-block d-sm-none d-md-inline-block pb-3 pb-md-2 pb-lg-0" src="/img/written-by-human-not-by-ai-black-tw.svg" alt="">
                    </div>
                  </div>
                </div>
                <div class="col-12 download-link-wrapper mt-1">
              ...
              <span class="row">
                <div class="col-12 not-by-ai-folder-wrapper rounded px-2 px-xl-3 pt-3 pb-2">
                  <div class="not-by-ai-folder fade-in-move-up position-relative pb-1">
                    ...
                    <div class="position-absolute bottom-0 z-3 w-100 pb-2 pb-mb-3 pb-lg-4 d-flex flex-column flex-lg-row align-items-center justify-content-evenly not-by-ai-badge-folder">
                      <img id="example-not-by-ai-badge-producer-wht" width="131" height="42" class="no-download img-fluid pb-3 pb-sm-4 pb-md-3 pb-lg-0" src="/img/produced-by-human-not-by-ai-white-tw.svg" alt="">
                      <img id="example-not-by-ai-badge-producer-blk" width="131" height="42" class="no-download img-fluid d-block d-sm-none d-md-inline-block pb-3 pb-md-2 pb-lg-0" src="/img/produced-by-human-not-by-ai-black-tw.svg" alt="">
                    </div>
                  </div>
                </div>
                <div class="col-12 download-link-wrapper mt-1">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-7 p-2 bg-white rounded-5 mt-3">
            ...
            <p class="small my-1">安啦！有超過<?php include '../all-stats.php'; ?>的頁面正使用著Not By AI貼紙。</p>
          </div>
        </div>
      </section>
    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <h3 class="marker">優點</h3>
          <ul class="nav nav-underline" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active fw-normal me-3" id="home-tab" data-bs-toggle="tab" data-bs-target="#business-tab-pane" type="button" role="tab" aria-controls="business-tab-pane" aria-selected="true"><img class="mb-1" src="img/industry.svg" alt=""> 對企業來說</button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link fw-normal" id="profile-tab" data-bs-toggle="tab" data-bs-target="#indivisual-tab-pane" type="button" role="tab" aria-controls="indivisual-tab-pane" aria-selected="false"><img class="mb-1" src="img/individual.svg" alt=""> 對個人來說</button>
            </li>
          </ul>
          <div class="tab-content pt-4 pb-4 px-3 bg-light" id="myTabContent">
            ...
            <div class="tab-pane fade" id="indivisual-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
              現今要判定一個作品是否為AI產生的十分困難，即使是專業人士或AI偵測器都未必可靠。使用Not By AI貼紙可以讓你的觀眾們了解你以人為出發點的創作力，並證明你的內容真的出自於你，而不是由ChatGPT、Claude，或Gemini之類的生成式AI所產生。<div class="mt-3">更重要的是，這能推廣真人原創內容的重要性。我們人類必須在這關鍵的時間點持續共同產出原創內容，以確保我們未來的內容不會被AI量產的回收內容給取代。
              <div class="row justify-content-center align-items-center mt-2 mb-3 px-3">
                <div class="col-5 text-center">
              ...
              我們提供100%免費的貼紙給非商業用途的內容創作者，因為我們是認真的想將這份Not By AI運動推廣到世界各地。如果你不吝幫忙，請考慮看看我們的付費方案或<a href="https://donate.stripe.com/dR66qd4c22hucOAdQS" target="_blank" class="text-decoration-underline">捐款幫助</a>。</div>
            </div>
          </div>
    ...
    <script type="text/javascript">
      const imageSets = {
        'example-not-by-ai-badge-artist-wht': [
          '/img/painted-by-human-not-by-ai-white-tw.svg',
          '/img/drafted-by-human-not-by-ai-white-tw.svg',
          '/img/designed-by-human-not-by-ai-white-tw.svg'
        ],
        'example-not-by-ai-badge-artist-blk': [
          '/img/photographed-by-human-not-by-ai-black-tw.svg',
          '/img/sculpted-by-human-not-by-ai-black-tw.svg',
          '/img/crafted-by-human-not-by-ai-black-tw.svg'
        ],
        'example-not-by-ai-badge-writer-wht': [
          '/img/written-by-human-not-by-ai-white-tw.svg',
          '/img/authored-by-human-not-by-ai-white-tw.svg'
        ],
        'example-not-by-ai-badge-writer-blk': [
          '/img/researched-by-human-not-by-ai-black-tw.svg',
          '/img/scripted-by-human-not-by-ai-black-tw.svg'
        ],
        'example-not-by-ai-badge-producer-wht': [
          '/img/filmed-by-human-not-by-ai-white-tw.svg',
          '/img/produced-by-human-not-by-ai-white-tw.svg',
          '/img/arranged-by-human-not-by-ai-white-tw.svg',
          '/img/developed-by-human-not-by-ai-white-tw.svg',
          '/img/composed-by-human-not-by-ai-white-tw.svg'
        ],
        'example-not-by-ai-badge-producer-blk': [
          '/img/produced-by-human-not-by-ai-black-tw.svg',
          '/img/animated-by-human-not-by-ai-black-tw.svg',
          '/img/sung-by-human-not-by-ai-black-tw.svg',
          '/img/narrated-by-human-not-by-ai-black-tw.svg',
          '/img/performed-by-human-not-by-ai-black-tw.svg'
        ]
      };
