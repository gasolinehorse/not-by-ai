    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>有專家估計在2025年，會有超過九成的線上內容為AI所產生<sup>1</sup>。在這樣的AI狂瀾之下，我們必須提醒自己AI是以人類過去的創作所訓練而成。換句話說，假如人類從此便全面仰賴AI來產生內容，這些新的內容恐怕只會是回收過重置的舊內容罷了。這對人類文明的進展恐將造成極大的威脅。唯有限制AI的使用並持續堅持原創內容才能確保人類的進步。</p>
          <figure>
        ...
        <section>
          ...
          <p>在了解什麼算是AI產生與什麼算是人類產生時常難以定義的前提下，如果你估計自己的內容有90%是人類所創作的，你便能將Not By AI貼紙加到你的網站、部落格、藝術品、影片、論文、書、Podcast，或其他型態的非商業用途的作品。若是商業用途而你也遵守Not By AI 90%規定，你便也符合可以註冊並付費使用的資格。這90%是可以包含使用AI來找靈感、產生像是隱私政策的法用文件（除非你的主題或服務項目是法律相關）、產生像是搜尋引擎最佳化（SEO）等非使用者會看到的程式碼、抓文法錯誤和錯字，以及翻譯。</p>
