      ...
      <div class="container">
          ...
          <div class="col-lg-11 col-xl-8 border-top pt-4">
            <div class="row align-content-around">
              ...
              <div class="col-md-6 pb-3">
                <h2>AI Backlash: Cara and ‘Not By AI’ Rage Against the Machine</h2>
        ...
        <div class="row justify-content-center text-start px-4 px-lg-0 mb-4 mb-lg-5">
          <div class="col-lg-11 col-xl-8 border-top pt-4">
            <div class="row align-content-around">
              <div class="col-md-3">
                <p class="small">June 12, 2024</p>
              </div>
              <div class="col-md-6 pb-3">
                <h2>Excuse Me, Is There AI in That?</h2>
        ...
        <div class="row justify-content-center text-start px-4 px-lg-0 mb-4 mb-lg-5">
          <div class="col-lg-11 col-xl-8 border-top pt-4">
            <div class="row align-content-around">
              <div class="col-md-3">
                <p class="small">February 18, 2024</p>
              </div>
              <div class="col-md-6 pb-3">
                <h2>‘Not by AI’ Badge Emerges to Combat AI-Generated Content Onslaught</h2>
        ...
        <div class="row justify-content-center text-start px-4 px-lg-0 mb-4 mb-lg-5">
          <div class="col-lg-11 col-xl-8 border-top pt-4">
            <div class="row align-content-around">
              <div class="col-md-3">
                <p class="small">January 12, 2024</p>
              </div>
              <div class="col-md-6 pb-3">
                <h2>Human-made Content Could Be The New Hype</h2>
