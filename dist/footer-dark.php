    <div class="container-fluid">
      <div class="row border-top text-center" style="border-color: #505050 !important;">
        <div class="col text-center py-3 text-center">
          <a href="https://notbyai.fyi/translate" class="display-6 text-white pt-3 me-3">Help Us Translate</a>
          <a href="https://notbyai.fyi/feedback" class="display-6 text-white pt-3 me-3">Feedback</a>
          <a href="https://notbyai.fyi/license" class="display-6 text-white pt-3 me-3">License</a>
          <a href="https://notbyai.fyi/about" class="display-6 text-white pt-3 me-3">About&nbsp;Us</a>
          <a href="https://notbyai.fyi/contact" class="display-6 text-white pt-3">Contact</a>
