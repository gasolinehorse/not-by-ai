      ...
      <div class="container pt-3">
        <div class="row mt-3">
          <div class="col-lg-4 text-center text-md-start pb-3">
            ...
            <div class="display-2 lh-sm pb-2 text-white">Human Minds Shape&nbsp;Tomorrow</div>
        ...
        <div class="row flex-column flex-md-row align-content-between pt-4 pb-5">
          <div class="col">
            <div class="display-6 text-center text-md-start opacity-50 pb-2 text-white">Not By AI © 2023 All rights reserved.</div>
          </div>
