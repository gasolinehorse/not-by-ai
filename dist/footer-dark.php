        ...
        <div class="row mt-3">
          ...
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              ...
              <li class="lh-sm pb-1"><a class="display-6 text-white" href="/lookup">Find a Not By AI Business or Individual</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
          ...
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2 text-white">Social</li>
              <li class="lh-sm pb-1"><a class="display-6 text-white" target="_blank" href="https://twitter.com/NotByAIBadge">X (Formerly Twitter)</a></li>
              <li class="lh-sm pb-1"><a class="display-6 text-white" target="_blank" href="https://www.facebook.com/notbyai">Facebook</a></li>
              <li class="lh-sm pb-1"><a class="display-6 text-white" target="_blank" href="https://www.linkedin.com/company/notbyai/">Linkedin</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
