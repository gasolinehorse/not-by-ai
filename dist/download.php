...
?>
    ...
    <div class="row justify-content-center px-4 px-lg-0">
      <div class="col-lg-9 pb-5">
        ...
        <p class="entry-content small mb-0">If your download hasn’t started after 10 seconds, please <a href="https://notbyai.fyi/contact" class="text-decoration-underline">contact us</a> so we can assist.</p>
      </div>
    </div>
