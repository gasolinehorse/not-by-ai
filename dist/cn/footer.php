      ...
      <div class="container pt-3">
        <div class="row mt-3">
          <div class="col-lg-4 text-center text-md-start pb-5 pb-lg-3">
            ...
            <div class="display-2 lh-sm pb-2">加入推广Not&nbsp;By&nbsp;AI运动&nbsp;</div>
            <p style="font-size: 1.3125rem;">凭着一张贴纸，我们一起鼓励人类继续产出原创内容。</p>
          ...
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">贴纸</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/cn/how-it-works">使用方法</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/cn/pricing">订阅计划</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/cn">Not By AI个人版</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/business">Not By AI商用版</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/cn/gallery">示例</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">资源</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help">资源中心</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/what-is-the-not-by-ai-90-rule">Not By AI 90%规定</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help#how-to">如何贴贴纸</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/help/guidelines">使用须知</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/translate">帮忙翻译</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <ul class="nav flex-column">
              <li class="fw-bold py-2">公司</li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/about">关于我们</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/feedback">反馈</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/media-assets">媒体资源</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/newsroom">新闻中心</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/meet-our-translators">翻译团队</a></li>
              <li class="lh-sm pb-1"><a class="display-6" href="https://notbyai.fyi/contact">联繫我们</a></li>
            </ul>
          </div>
          <div class="text-center text-md-start col-md-3 col-lg-2">
            <a href="https://notbyai.fyi/hi/not-by-ai"><img class="pt-3 d-block mx-auto" src="/img/written-by-human-not-by-ai-white-cn.svg" alt="Written By Human, Not By AI"></a>
        ...
        <div class="row flex-column flex-md-row align-content-between pt-4 pb-5">
          ...
          <div class="col justify-content-center justify-content-md-end text-center text-md-end">
            <a href="https://notbyai.fyi/license" class="display-6 me-4 opacity-50">合同</a>
            <a href="https://notbyai.fyi/privacy-policy" class="display-6 me-4 opacity-50">隐私政策</a>
            <a href="https://notbyai.fyi/terms-and-conditions" class="display-6 me-4 opacity-50">条款</a>
            <a href="#" class="termly-display-preferences display-6 opacity-50">同意偏好设置</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content border-0 rounded-0 download-popup">
        <div class="modal-header px-md-5 py-md-4 align-items-start">
          <div class="modal-title fs-3 h3" id="downloadEmailLabel">下载Not By AI贴纸</div>
                  ...
                  <div class="not-by-ai-options border rounded-3 my-2 pt-3 px-2 px-md-3 bg-white shadow h-100">
                    ...
                    <label class="form-check-label pt-1 pt-sm-3 w-100 cursor-pointer h-100" for="usage2">
                      <div class="row justify-content-center align-items-center mb-3 px-5 px-sm-3 d-none d-sm-flex">
                        <div class="col-5">
                          <img id="not-by-ai-offering-badges" class="img-fluid" srcset="/img/sign-up-not-by-ai-badges@2x.png 2x" src="/img/sign-up-not-by-ai-badges.png" alt="Not By AI 贴纸">
                        </div>
                        <div class="col-1 px-0 text-center">
                          <div class="h3">+</div>  
                        </div>
                        <div class="col-5">
                          <img id="not-by-ai-offering-badges" class="img-fluid shadow" srcset="/img/sign-up-not-by-ai-pages@2x.png 2x" src="/img/sign-up-not-by-ai-pages.png" alt="Not By AI 頁面">
                        </div>
                      </div>
                      <h4 class="h5 mb-0">下载贴纸以及阐述我的创作理念</h4>
                      <div class="mt-2" style="font-size: 0.75rem;"><span class="opacity-50">每月5美元起</span><span class="d-block d-md-inline-block border rounded-2 ms-lg-2 mt-1 mt-lg-0 py-1 px-2"><span class="opacity-50">适用于商业&个人用途</span></span></div>
                    </div>
                  </label>
                </div>
                <div class="col-6">
                  <div class="not-by-ai-options border rounded-3 my-2 pt-3 px-2 px-md-3 bg-white shadow h-100">
                    ...
                    <label class="form-check-label pt-1 pt-sm-3 w-100 cursor-pointer h-100" for="usage1">
                      ...
                      <h4 class="h5 mb-0">下载贴纸而已</h4>
                      <div class="mt-2" style="font-size: 0.75rem;"><span class="opacity-50">想付多少就付多少</span><span class="d-block d-md-inline-block border rounded-2 ms-lg-2 mt-1 mt-lg-0 py-1 px-2"><span class="opacity-50">仅适用于个人用途</span></span></div>
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div id="personal-form" class="mt-md-3 px-1 px-sm-3 px-lg-1">
              <div class="row justify-content-between">
                ...
                <div id="donate-box" class="col-6 col-md-5 col-lg-4 border-md pb-1 pb-md-3 pt-2 px-md-4 rounded-3 mt-md-0">
                  <label for="your-price">想付多少就付多少</label>
              ...
              <div class="pt-3">
                <div class="d-flex">
                  <input type="checkbox" id="marketing" name="marketing" value="I want to receive news such as updates, tips, resources, and discounts."><label for="marketing">我想收到更新、使用技巧、资源，与折价券等。</label>
                </div>
              </div>
              <label for="nogo" class="d-none">Company</label>
              <input type="text" name="nogo" class="d-none">
              <input id="not-by-ai-badges-download-no-cost" class="g-recaptcha btn mt-4" data-sitekey="6LcD-NsnAAAAAJ1SLXijs4KO4J2IX2OJHbABIumM" data-callback="onSubmit" data-action="submit" type="submit" value="把贴纸寄给我">
              <a id="not-by-ai-badges-download-with-donation-no-cp" style="display: none;" href="https://donate.stripe.com/dR67uh7oe2hucOAcMR" class="btn mt-4">把贴纸寄给我</a>
