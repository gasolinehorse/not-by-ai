    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>在了解什麽算是AI生成与什麽算是人类生成时常难以定义的前提下，如果你估计自己的内容有90%是人类所创作的，你便能将Not By AI贴纸加到你的网站、部落格、艺术品、视频、论文、书、播客，或其他型态的非商业用途的作品。若是商业用途而你也遵守Not By AI 90%规定，你便也符合可以注册并付费使用的资格。这90%是可以包含使用AI来找灵感、生成像是隐私政策的法用文件（除非你的主题或服务项目是法律相关）、生成像是搜索引擎优化（SEO）等非用戶会看到的代码、找语法错误和错字，以及翻译。</p>
