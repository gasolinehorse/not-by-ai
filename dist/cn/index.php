    ...
    <div id="top-nav-stop-point" class="row justify-content-center">
      ...
      <div class="col-md-7 col-xl-5 text-start px-4 px-lg-0 pt-3 pt-md-5">
        ...
        <section>
          ...
          <p>有专家估计在2025年，会有超过九成的线上内容为AI所生成<sup>1</sup>。在这样的AI狂澜之下，我们必须提醒自己AI是以人类过去的创作所训练而成。换句话说，假如人类从此便全面仰赖AI来生成内容，这些新的内容恐怕只会是回收过重置的旧内容罢了。这对人类文明的进展恐将造成极大的威胁。唯有限制AI的使用并持续坚持原创内容才能确保人类的进步。</p>
          <figure>
        ...
        <section>
          ...
          <p>在了解什麽算是AI生成与什麽算是人类生成时常难以定义的前提下，如果你估计自己的内容有90%是人类所创作的，你便能将Not By AI贴纸加到你的网站、部落格、艺术品、影片、论文、书、播客，或其他型态的非商业用途的作品。若是商业用途而你也遵守Not By AI 90%规定，你便也符合可以注册并付费使用的资格。这90%是可以包含使用AI来找灵感、生成像是隐私政策的法用文件（除非你的主题或服务项目是法律相关）、生成像是搜索引擎优化（SEO）等非用戶会看到的代码、找语法错误和错字，以及翻译。</p>
