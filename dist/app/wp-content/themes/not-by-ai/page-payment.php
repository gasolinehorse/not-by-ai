	...
	<div class="container">
	  <div class="row justify-content-center">
		  <div class="col-sm-7 col-xl-5">
		    <h1 class="h2 pb-0 pt-3 pre-login text-center">Checkout</h1>
		    <p class="mb-4 pb-4 text-center border-bottom"><span class="fw-bold">1.0</span> x <span class="fw-bold">Not By AI Creator Page</span></p>
				<?php
				while ( have_posts() ) :
					the_post();
				...
				endwhile;
				?>
				<p class="pt-2 pb-3 small text-lg-center opacity-50">You will receive a full refund if your Creator Page application is rejected.</p>
				<a class="mt-lg-5 opacity-50 xs d-block text-end" href="#" onclick="history.back()">Go back</a>
	    </div>
	  </div>
	</div>
</main>
