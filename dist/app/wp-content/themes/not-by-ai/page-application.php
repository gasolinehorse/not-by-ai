  ...
  <main>
    <div id="forms" class="application pb-5">
      <div class="row justify-content-center px-4 px-lg-0 text-start px-2 px-lg-5">
        <div class="col-md-6 overflow-y-scroll custom-scrollbar pt-4" style="height: calc(100vh - 70px);">
          <header>
        ...
        <div class="col-md-6 overflow-y-scroll overflow-x-hidden custom-scrollbar d-none d-md-block bg-light py-4" style="height: calc(100vh - 70px);">
          <div class="d-flex justify-content-between align-items-center">
            <h2 class="h5 opacity-50 pt-2">Preview</h2>
          ...
          <div id="formPreview" class="browser mt-4 pe-none bg-white" style="zoom: 0.5; transform: translateX(5%);">
            <div>
              ...
              <div class="row mx-0 no-md-bg justify-content-center text-start pt-1 pb-3 mb-3 mb-md-4 bg-light" style="background-image: url(/img/creator-profile-of-not-by-ai.svg); background-position: bottom right; background-repeat: no-repeat; background-size: contain;">
                <div class="col-md-11 pt-1">
                  <div class="row position-relative z-1">
                    <div class="col">
                      <small class="xs"><a href="#" class="text-decoration-underline">Home</a> <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> Creator Profiles <svg width="5" height="7" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.793 3.5.646 1.354l.708-.708L4.207 3.5 1.354 6.354l-.708-.708L2.793 3.5Z" fill="#000"/></svg> <span class="previewProjectName"><span class="blur-placeholder">Not By AI</span></span></small>
                    </div>
                  </div>
                  <div class="row justify-content-start pt-3 pb-2">
                    <div class="col-auto border rounded d-flex overflow-hidden justify-content-center align-items-center p-0 bg-white" style="width: 95px; height: 95px; margin-left: calc(var(--bs-gutter-x) * .5)">
                      <img id="logoPreview" width="95" class="img-fluid position-relative z-1" src="/img/idkwicsyf/sample-photo.jpg" alt="logo">
                    </div>
                    <div class="col-auto">
                      <div class="h5 mt-1 mb-0 ls-normal" style="letter-spacing: 0;">Not By AI - Creator Profile</div>
                      <div class="display-2 my-0 lh-sm" style="background-color: #f9f8f7; box-shadow: #f9f8f7 10px 0px 40px 40px;"><span class="previewProjectName"><span class="blur-placeholder">Not By AI</span></span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"><path fill="#007CE4" fill-rule="evenodd" d="m9.545 18.48-1.45.885a1.781 1.781 0 0 1-2.616-.952l-.543-1.61a.871.871 0 0 0-.695-.584l-1.68-.254a1.782 1.782 0 0 1-1.392-2.412l.62-1.582a.871.871 0 0 0-.158-.894L.507 9.803A1.782 1.782 0 0 1 .991 7.06l1.492-.814a.872.872 0 0 0 .454-.786l-.042-1.699a1.782 1.782 0 0 1 2.133-1.79l1.666.336c.32.065.65-.055.853-.31L8.607.67a1.782 1.782 0 0 1 2.784 0l1.06 1.328a.872.872 0 0 0 .854.31l1.665-.335a1.781 1.781 0 0 1 2.133 1.79l-.041 1.698a.872.872 0 0 0 .454.786l1.492.814a1.782 1.782 0 0 1 .483 2.742l-1.123 1.274a.871.871 0 0 0-.158.894l.62 1.582a1.782 1.782 0 0 1-1.392 2.412l-1.68.254a.871.871 0 0 0-.696.583l-.542 1.61a1.782 1.782 0 0 1-2.616.953l-1.45-.885a.872.872 0 0 0-.909 0Z" clip-rule="evenodd"/><path fill="#fff" fill-rule="evenodd" d="m15.083 8.685-5.982 5.983-4.185-4.185 1.506-1.506 2.679 2.678 4.476-4.476 1.506 1.506Z" clip-rule="evenodd"/></svg></div>
                      <small class="xs">By <span class="previewCreatedBy"><span class="blur-placeholder">Not By AI</span></span></small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row justify-content-center">
                <div class="col-md-7 col-xl-7 text-start px-4 px-lg-0 pt-3 pt-md-2 order-md-3">
                  <section class="border-bottom pb-4 position-relative">
                    <div class="row mx-0 border-bottom mb-4">
                      <div class="col-1 pe-1">
                        <img class="img-fluid" alt="" src="/img/not-by-ai-quote.svg">
                      </div>
                      <div class="col-11">
                        <div class="display-3 pb-3"><span class="previewCreatedBy"><span class="blur-placeholder">Not By AI</span></span> affirms that the applicable content of <span class="previewProjectName"><span class="blur-placeholder">Not By AI</span></span> is majorly or entirely created by one or more humans. It adheres to the Not By AI 90% Rule and has undergone human review.<sup>1</sup></div>
                      </div>
                    </div>
                    <h5 class="d-inline">Applicable badge(s):</h5>
                    <span class="previewArtistBadge blur-placeholder"><img class="ms-3" src="/img/painted-by-human-not-by-ai-white.svg" alt="Painted by Human, Not By AI"></span>
                    <span class="previewWriterBadge blur-placeholder"><img class="ms-3" src="/img/written-by-human-not-by-ai-white.svg" alt="Written by Human, Not By AI"></span>
                    <span class="previewProducerBadge blur-placeholder"><img class="ms-3" src="/img/produced-by-human-not-by-ai-white.svg" alt="Produced by Human, Not By AI"></span>
                  </section>
                  <section>
                    <div class="h3 pt-4 pt-md-4">About <span class="previewProjectName"><span class="blur-placeholder">Not By AI</span></span></div>
                   ...
                   <div class="h3 pt-4 pt-md-4">Support Assets</div>
                   <div class="row bg-light py-4 px-3 align-items-center text-center">
                      <div class="col-6 col-lg-3">
                        <img class="img-fluid mb-2" src="/img/idkwicsyf/sample-photo.jpg" alt="">
                ...
                <div class="col-md-1 border-start order-2" style="transform: translateX(20px);"></div>
                <aside class="col-md-3 col-xl-3 text-start px-4 px-md-0 order-md-1">
                  <div class="nav flex-column position-sticky top-0 pt-md-3 pe-md-2 pe-lg-4 creator-profile">
                    <div class="row pb-3 px-2 mb-3">
                      <div class="col">
                        <div class="h5 pb-1">Project Details</div>
                        <div class="pb-1 pb-lg-2 pt-2">
                        ...
                        <div class="pb-1 pb-lg-2 pt-2">
                          ...
                          <div class="creator-profile__field">
                            <ul class="mb-0 ps-2">
                              ...
                              <li id="previewLimitNone" style="display: none;">- None (No AI was used)</li>
                            </ul>
                          </div>
                        </div>
                        <div class="pb-1 pb-lg-2 pt-2">
